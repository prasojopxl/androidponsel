...
export default function Home() {
  ...
  const [topPostFeature, setTopPostFeature] = useState([]);
  ...
  const getBanerTop = () => {
    ...
    .then((res)=> {
      ...
      setTopPostFeature(res.data[0].feature.add_feature)
    })
  }
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-6">
                            <div className="txtleft">
                              ...
                              <p>{
                                item.SEO != null ? (item.SEO.description_tag).substr(0,200) : 
                                topPostFeature.map((data)=> {
                                  return (
                                    <React.Fragment>
                                      <span style={{textTransform:"capitalize"}}>{data.title_spec}</span>: {data.info_spec}<br/>
                                    </React.Fragment>
                                  )
                                })
